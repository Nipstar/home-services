...
const PremiumTrustBadges = ({ className = '' }) => {
    return (
        <div className={`flex flex-wrap gap-3 mt-8 ${className}`}>
            ...
            <div className="group relative flex items-center gap-2 px-3 py-1.5 md:px-4 md:py-2 bg-white rounded-full border border-gray-100 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.1)] hover:shadow-md hover:border-success/30 transition-[box-shadow,border-color,transform] duration-300 ease-out hover:-translate-y-0.5">
            ...
            <div className="group relative flex items-center gap-2 px-3 py-1.5 md:px-4 md:py-2 bg-white rounded-full border border-gray-100 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.1)] hover:shadow-md hover:border-primary/30 transition-[box-shadow,border-color,transform] duration-300 ease-out hover:-translate-y-0.5">
            ...
            <div className="group relative flex items-center gap-2 px-3 py-1.5 md:px-4 md:py-2 bg-white rounded-full border border-gray-100 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.1)] hover:shadow-md hover:border-coral/30 transition-[box-shadow,border-color,transform] duration-300 ease-out hover:-translate-y-0.5">
